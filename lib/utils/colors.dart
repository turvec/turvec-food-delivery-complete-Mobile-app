...
class AppColors{
  ...
  static final Color mainColor = const Color(0xFFFF720D);
  //static final Color mainColor = const Color(0xFFfa7552);
  static final Color iconColor1 = const Color(0xFFFF720D);
  static final Color iconColor2 = const Color(0xFFFF720D);
